        ...
        if ($codi_rol == "1") {
            ...
            return
                    ...
                    . '</a>' .
                        '<ul class="">' .
                            "<li>" .
                            '<a href="' . base_url() . 'test/ancho_completo">Usuario</a>' .
                            "</li>" .
                            "<li>" .
                            '<a href="' . base_url() . 'test/sidebar">Proveedor</a>' .
                            "</li>" .
                            
                            "<li>" .
                            '<a href="' . base_url() . 'test/sidebar">Cliente</a>' .
                            "</li>" .
                            "<li>" .
                            '<a href="' . base_url() . 'test/sidebar">Empleado</a>' .
                            "</li>" .
                            "<li>" .
                            '<a href="' . base_url() . 'test/sidebar">Producto</a>' .
                            "</li>" .
                        '</ul>' .
                    "</li>".
                    "<li>" .
